    ...
    const wordDoc = new Document({
      ...
      sections: [
        ...
        // Section 3 : portrait — document avec header/footer Askida
        {
          ...
          properties: {
            // Marges en DXA (1 cm = 567). L'en-tete est dessine DANS la marge
            // superieure : avec un logo de 40 px (600 DXA), un espacement de
            // 120 et le filet, il descend a environ 1470 depuis le haut de
            // page, alors que la marge s'arretait a 1440. Le texte commencait
            // donc avant la fin de l'en-tete.
            //
            // On fixe explicitement l'offset de l'en-tete et du pied plutot
            // que de laisser jouer le defaut de Word (720), pour que la mise
            // en page ne dependre pas d'une valeur implicite :
            //
            //   en-tete : 567 (1 cm) + 600 + 120 + filet  ~= 1300
            //   marge   : 1985 (3,5 cm)                    -> 685 d'air
            page: {
              size:   { width: 11906, height: 16838 },
              margin: { top: 1985, right: 1134, bottom: 1418, left: 1134, header: 567, footer: 567 }
            }
          },
          children: doc
        }
